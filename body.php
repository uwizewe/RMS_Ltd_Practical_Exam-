				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title">New Medicines</h3>
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Winter Care</a></li>
									<li><a data-toggle="tab" href="#tab1">Diabetes</a></li>
									<li><a data-toggle="tab" href="#tab1">Healthcare</a></li>
